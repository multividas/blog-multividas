    ...
    <main class="container px-3 py-4">
      ...
      <article class="my-3">
        <section class="text-right">
          ...
          <h1 class="fw-bold text-primary mb-3">About Multividas</h1>
        </section>
        <section>
          <div class="my-4">
            <g-image
              src="~/assets/png/multividas-blogging-platform-multividas-social-media-blog-multividas-posts-threads-multividas-comments-discussions-multividas-short-texts-multividas-social-blogging.png"
            ...
            />
            <p class="text-center text-muted text-sm my-2">About Multividas</p>
          </div>
          <div class="my-3">
            <section class="mb-5">
              ...
              <p>
                ...
                <a
                  ...
                  >@Soulaimane Yahya</a
                >'s living room and neighborhood library in 2023 and was
                released and launched in July 2024.
              </p>
            </section>
            ...
            <section class="mb-5">
              ...
              <p>
                ...
                leaving comments and participating in replies within depth
                articles.
              </p>
            </section>
            ...
            <section class="mb-5">
              ...
              <p class="mb-2">
                Privacy and security are our priority at Multividas.com. We'll

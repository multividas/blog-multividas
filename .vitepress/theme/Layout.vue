  ...
  <div class="antialiased dark:bg-slate-900">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 xl:max-w-5xl xl:px-0">
      <nav class="flex justify-between items-center py-10 font-bold">
        <a class="text-xl" href="/" aria-label="Multividas blog">
          ...
          <span v-if="!frontmatter.index" class="hidden md:inline dark:text-white">Multividas blog</span>
        </a>
        <div class="text-sm text-gray-500 dark:text-white leading-5">
          <a class="hover:text-gray-700 dark:hover:text-gray-200" href="https://github.com/multividas" target="_blank"
            rel="noopener">
